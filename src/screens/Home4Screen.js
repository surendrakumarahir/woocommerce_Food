...
class Home1 extends Component {
  ...
  static getDerivedStateFromProps(props) {
    return {
      length: props.isLoading.cartItems.recentViewedProducts.length !== undefined ?
      props.isLoading.cartItems.recentViewedProducts.length : 0
    };
}
  // eslint-disable-next-line react/sort-comp
  constructor(props) {
  ...
  render() {
    return this.state.activityIndicatorTemp ? (
      ...
      <FlatList
        ...
        renderItem={() => (
          <View style={styles.container1,{backgroundColor: this.props.isLoading.Config.card_style === 11 
            || this.props.isLoading.Config.card_style === 12 || this.props.isLoading.Config.card_style === 15?
            "#F2F2F2": themeStyle.backgroundColor}}>
            <Spinner
            ...
            <View>
              <Banner navigation={this.props.navigation} bannerSelect={this.props.isLoading.Config.appInProduction ? 4 : this.props.isLoading.Config.banner_style}/>
            </View>
            <CategoryFlatList
