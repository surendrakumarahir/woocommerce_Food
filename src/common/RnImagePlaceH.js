...
class ImageLoad extends React.Component {
  ...
  render() {
    const {
      ...
      customImagePlaceholderDefaultStyle,borderTopLeftRadius,borderTopRightRadius
    } = this.props;
    return(
      <ImageBackground
      ...
      >
        {
          ...
          <View 
            style={[styles.viewImageStyles, { borderRadius: borderRadius },{ borderTopRightRadius:borderTopRightRadius},{borderTopLeftRadius:borderTopLeftRadius}, backgroundColor ? { backgroundColor: backgroundColor } : {}]}
          >
            {
            ...
            <Image
              ...
              source={placeholderSource ? placeholderSource : require('../images/placeholder.png')}
            >
            </Image>
          </View>
        }
